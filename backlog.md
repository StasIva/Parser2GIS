...
| # | Task | Hours | Status |
|---|------|-------|--------|
| 2.1 | Research 2GIS public data endpoints (web, API, map tiles) | 3 | TODO |
| 2.2 | Implement HTTP client with configurable headers and timeouts | 3 | TODO |
| 2.3 | Implement city search/resolve (translate city name → 2GIS city ID) | 2 | TODO |
| 2.4 | Implement rubric search/resolve (translate rubric → 2GIS rubric ID) | 2 | TODO |
| 2.5 | Implement organization list fetch by city + rubric | 4 | TODO |
| 2.6 | Implement individual organization card fetch | 4 | TODO |
| 2.7 | Implement rate limiter with configurable delay and burst | 2 | TODO |
| 2.8 | Implement retry with exponential backoff (max 3 retries) | 2 | TODO |
| 2.9 | Implement user-agent rotation | 1 | TODO |
...
| # | Task | Hours | Status |
|---|------|-------|--------|
| 3.1 | Implement OrganizationParser — extract core fields from 2GIS response | 3 | TODO |
| 3.2 | Implement address normalizer (city, street, building, postal code) | 2 | TODO |
| 3.3 | Implement phone extractor + formatter (multiple phones, mobile detection) | 3 | TODO |
| 3.4 | Implement email extractor | 1 | TODO |
| 3.5 | Implement website/social extractor | 1 | TODO |
| 3.6 | Implement work hours parser | 1 | TODO |
| 3.7 | Implement coordinates extractor (lat/lon) | 1 | TODO |
| 3.8 | Implement deduplication engine (source_id, URL, name+address) | 2 | TODO |
...
| # | Task | Hours | Status |
|---|------|-------|--------|
| 4.1 | Implement Task data class and enums (created, running, paused, done, error) | 1 | TODO |
| 4.2 | Implement TaskRepo (CRUD, status updates, progress tracking) | 2 | TODO |
| 4.3 | Implement TaskManager — create task, validate city+rubric, manage lifecycle | 3 | TODO |
| 4.4 | Implement async task queue (QThreadPool or asyncio) | 4 | TODO |
| 4.5 | Implement pause/resume/stop for running tasks | 3 | TODO |
| 4.6 | Implement crash recovery (save checkpoint, resume from last org) | 3 | TODO |
| 4.7 | Implement progress tracking (orgs found, saved, errors) | 2 | TODO |
| 4.8 | Implement TaskContextMenu actions (view, export single, reset, rerun, delete, open folder) | 2 | TODO |
| 4.9 | Implement task count/summary endpoint | 1 | TODO |
...
| # | Task | Hours | Status |
|---|------|-------|--------|
| 5.1 | Implement OrganizationRepo (save, find, deduplicate, search) | 2 | TODO |
| 5.2 | Implement ContactRepo (save contacts per organization) | 1 | TODO |
| 5.3 | Implement ExportRepo (log each export operation) | 1 | TODO |
| 5.4 | Implement ParseLogRepo (per-task log entries) | 1 | TODO |
| 5.5 | Implement full-text search on organization names | 2 | TODO |
| 5.6 | Implement DB integrity check + repair on startup | 2 | TODO |
...
| # | Task | Hours | Status |
|---|------|-------|--------|
| 6.1 | Implement MainWindow with toolbar, task table, status bar | 4 | TODO |
| 6.2 | Implement TaskTableModel with Qt MVC pattern | 3 | TODO |
| 6.3 | Implement toolbar buttons (Create, Start, Stop, Settings) | 2 | TODO |
| 6.4 | Implement CityRubricDialog with tree view and search | 5 | TODO |
| 6.5 | Implement TaskNameDialog with auto-generation | 2 | TODO |
| 6.6 | Implement progress column (0–100% with status text) | 2 | TODO |
| 6.7 | Implement ExportDialog (format, path, progress, success) | 3 | TODO |
| 6.8 | Implement SettingsDialog (threads, delays, paths, proxy) | 3 | TODO |
| 6.9 | Implement AppController — wire all GUI to TaskManager | 4 | TODO |
| 6.10 | Implement status bar with task count and last action | 2 | TODO |
| 6.11 | Implement Russian localization for all UI strings | 3 | TODO |
...
| # | Task | Hours | Status |
|---|------|-------|--------|
| 7.1 | Design exporter interface (abstract base class) | 1 | TODO |
| 7.2 | Implement XLSX exporter (all fields, text-formatted phones) | 4 | TODO |
| 7.3 | Implement CSV exporter with UTF-8 BOM and Windows-1251 options | 3 | TODO |
| 7.4 | Implement JSON exporter | 2 | TODO |
| 7.5 | Implement multi-task export (all / selected) | 2 | TODO |
| 7.6 | Implement export progress callback | 2 | TODO |
| 7.7 | Implement export validation (verify file, count rows) | 2 | TODO |
| 7.8 | Implement export notification (success dialog with count) | 1 | TODO |
...
| # | Task | Hours | Status |
|---|------|-------|--------|
| 8.1 | Implement application-wide logger (file + console) | 2 | TODO |
| 8.2 | Implement per-task logger (separate file per task) | 2 | TODO |
| 8.3 | Implement source error logger (2GIS errors only) | 1 | TODO |
| 8.4 | Implement export logger | 1 | TODO |
| 8.5 | Implement task summary reporter (completion stats) | 2 | TODO |
| 8.6 | Implement log rotation and max size limits | 1 | TODO |
| 8.7 | Implement user-friendly error messages (Russian) | 2 | TODO |
...
| 9.8 | Smoke test on Windows VM | 2 | TODO |
...
EPIC-5 (Storage) — Tasks 5.1–5.8
EPIC-8 (Logging) — Tasks 8.2, 8.4, 8.5, 8.6

### Stage 4
EPIC-7 (Export) — Tasks 7.1–7.8
EPIC-2 (2GIS Source) — Task 2.10
